# DocAI Browser Extension

A Chrome/Firefox browser extension that adds DocAI as a sidebar widget on Canvas pages. The sidebar can be collapsed, expanded, and opened in fullscreen mode.
...
4. **Verify Installation**:
   - You should see "DocAI" in your extensions list
